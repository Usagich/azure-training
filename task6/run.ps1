...
(
    ...
    [string] $TemplateURL1 = "https://naliaksandra.blob.core.windows.net/templates/appInit6.json",
    [string] $TemplateURL2 = "https://naliaksandra.blob.core.windows.net/templates/trafficManager.json",
